...
SOURCES		:=	$(FORMATSOURCES) 3rd-party/source
DATA		:=	data
FORMATINCLUDES	:= include
...
clean:
	@echo clean ...
	@rm -fr $(BUILD) $(OUTDIR) $(TARGET).pfs0 $(TARGET).nso $(TARGET).nro $(TARGET).nacp $(TARGET).elf open_and_copy_to_sd
#---------------------------------------------------------------------------------
format:
